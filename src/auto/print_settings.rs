...
impl PrintSettings {
    ...
    pub fn get_page_ranges(&self) -> Vec<PageRange> {
        unsafe {
            ...
            let ret = FromGlibContainer::from_glib_full_num(gtk_sys::gtk_print_settings_get_page_ranges(self.to_glib_none().0, num_ranges.as_mut_ptr()), num_ranges.assume_init() as usize);
            ret
        }
    }
