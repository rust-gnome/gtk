...
impl<O: IsA<TreeModelFilter>> TreeModelFilterExt for O {
    ...
    fn get_model(&self) -> Option<TreeModel> {
        unsafe {
            from_glib_none(gtk_sys::gtk_tree_model_filter_get_model(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_visible_column(&self, column: i32) {
        unsafe {
            gtk_sys::gtk_tree_model_filter_set_visible_column(self.as_ref().to_glib_none().0, column);
        }
    }
    ...
    fn set_visible_func<P: Fn(&TreeModel, &TreeIter) -> bool + 'static>(&self, func: P) {
        ...
        unsafe {
            gtk_sys::gtk_tree_model_filter_set_visible_func(self.as_ref().to_glib_none().0, func, Box_::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }
    ...
    fn get_property_child_model(&self) -> Option<TreeModel> {
        unsafe {
            ...
            value.get().expect("Return Value for property `child-model` getter")
        }
    }
}
