...
impl<O: IsA<CellRendererText>> CellRendererTextExt for O {
    ...
    fn get_property_align_set(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `align-set` getter").unwrap()
        }
    }
    ...
    fn get_property_ellipsize_set(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `ellipsize-set` getter").unwrap()
        }
    }
    ...
    fn get_property_max_width_chars(&self) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `max-width-chars` getter").unwrap()
        }
    }
    ...
    fn get_property_placeholder_text(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `placeholder-text` getter")
        }
    }
    ...
    fn get_property_single_paragraph_mode(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `single-paragraph-mode` getter").unwrap()
        }
    }
    ...
    fn get_property_width_chars(&self) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `width-chars` getter").unwrap()
        }
    }
    ...
    fn get_property_wrap_width(&self) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `wrap-width` getter").unwrap()
        }
    }
