...
impl<O: IsA<ComboBox>> ComboBoxExt for O {
    ...
    fn set_row_separator_func<P: Fn(&TreeModel, &TreeIter) -> bool + 'static>(&self, func: P) {
        ...
        unsafe {
            gtk_sys::gtk_combo_box_set_row_separator_func(self.as_ref().to_glib_none().0, func, Box_::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }
    ...
    fn get_property_has_frame(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `has-frame` getter").unwrap()
        }
    }
    ...
    fn get_property_popup_shown(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `popup-shown` getter").unwrap()
        }
    }
    ...
    fn emit_popdown(&self) -> bool {
        ...
        res.unwrap().get().expect("Return Value for `emit_popdown`").unwrap()
    }
