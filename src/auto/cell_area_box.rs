...
impl CellAreaBox {
    pub fn new() -> CellAreaBox {
        ...
        unsafe {
            CellArea::from_glib_none(gtk_sys::gtk_cell_area_box_new()).unsafe_cast()
        }
    }
}
...
impl<O: IsA<CellAreaBox>> CellAreaBoxExt for O {
    fn get_spacing(&self) -> i32 {
        unsafe {
            gtk_sys::gtk_cell_area_box_get_spacing(self.as_ref().to_glib_none().0)
        }
    }

    fn pack_end<P: IsA<CellRenderer>>(&self, renderer: &P, expand: bool, align: bool, fixed: bool) {
        unsafe {
            gtk_sys::gtk_cell_area_box_pack_end(self.as_ref().to_glib_none().0, renderer.as_ref().to_glib_none().0, expand.to_glib(), align.to_glib(), fixed.to_glib());
        }
    }

    fn pack_start<P: IsA<CellRenderer>>(&self, renderer: &P, expand: bool, align: bool, fixed: bool) {
        unsafe {
            gtk_sys::gtk_cell_area_box_pack_start(self.as_ref().to_glib_none().0, renderer.as_ref().to_glib_none().0, expand.to_glib(), align.to_glib(), fixed.to_glib());
        }
    }
    ...
    fn connect_property_spacing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_spacing_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkCellAreaBox, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
