...
impl<O: IsA<StyleContext> + IsA<glib::object::Object>> StyleContextExt for O {
    ...
    fn get_background_color(&self, state: StateFlags) -> gdk::RGBA {
        unsafe {
            ...
            ffi::gtk_style_context_get_background_color(self.to_glib_none().0, state, color.to_glib_none_mut().0);
            color
        }
    }
    ...
    fn get_border_color(&self, state: StateFlags) -> gdk::RGBA {
        unsafe {
            let mut color = gdk::RGBA::uninitialized();
            ffi::gtk_style_context_get_border_color(self.to_glib_none().0, state, color.to_glib_none_mut().0);
            color
        }
    }
    ...
    fn get_color(&self, state: StateFlags) -> gdk::RGBA {
        unsafe {
            let mut color = gdk::RGBA::uninitialized();
            ffi::gtk_style_context_get_color(self.to_glib_none().0, state, color.to_glib_none_mut().0);
            color
        }
    }
    ...
    fn to_string(&self, flags: StyleContextPrintFlags) -> String {
        unsafe {
            from_glib_full(ffi::gtk_style_context_to_string(self.to_glib_none().0, flags))
        }
    }
