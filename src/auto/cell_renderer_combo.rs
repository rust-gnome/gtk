...
impl<O: IsA<CellRendererCombo>> CellRendererComboExt for O {
    fn get_property_has_entry(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `has-entry` getter").unwrap()
        }
    }
    ...
    fn get_property_model(&self) -> Option<TreeModel> {
        unsafe {
            ...
            value.get().expect("Return Value for property `model` getter")
        }
    }
    ...
    fn get_property_text_column(&self) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `text-column` getter").unwrap()
        }
    }
