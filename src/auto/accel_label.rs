...
impl<O: IsA<AccelLabel>> AccelLabelExt for O {
    fn get_accel(&self) -> (u32, gdk::ModifierType) {
        unsafe {
            ...
            gtk_sys::gtk_accel_label_get_accel(self.as_ref().to_glib_none().0, accelerator_key.as_mut_ptr(), accelerator_mods.as_mut_ptr());
    ...
    fn get_property_accel_closure(&self) -> Option<glib::Closure> {
        unsafe {
            ...
            value.get().expect("Return Value for property `accel-closure` getter")
        }
    }
