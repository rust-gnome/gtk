...
pub trait GtkMenuExt: 'static {
    ...
    fn set_property_attach_widget<P: IsA<Widget> + SetValueOptional>(&self, attach_widget: Option<&P>);
...
impl<O: IsA<Menu>> GtkMenuExt for O {
    ...
    fn get_property_anchor_hints(&self) -> gdk::AnchorHints {
        unsafe {
            ...
            value.get().expect("Return Value for property `anchor-hints` getter").unwrap()
        }
    }
    ...
    fn get_property_menu_type_hint(&self) -> gdk::WindowTypeHint {
        unsafe {
            ...
            value.get().expect("Return Value for property `menu-type-hint` getter").unwrap()
        }
    }
    ...
    fn get_property_rect_anchor_dx(&self) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `rect-anchor-dx` getter").unwrap()
        }
    }
    ...
    fn get_property_rect_anchor_dy(&self) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `rect-anchor-dy` getter").unwrap()
        }
    }
    ...
    fn get_item_bottom_attach<T: IsA<MenuItem>>(&self, item: &T) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `bottom-attach` getter").unwrap()
        }
    }
    ...
    fn get_item_left_attach<T: IsA<MenuItem>>(&self, item: &T) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `left-attach` getter").unwrap()
        }
    }
    ...
    fn get_item_right_attach<T: IsA<MenuItem>>(&self, item: &T) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `right-attach` getter").unwrap()
        }
    }
    ...
    fn get_item_top_attach<T: IsA<MenuItem>>(&self, item: &T) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `top-attach` getter").unwrap()
        }
    }
