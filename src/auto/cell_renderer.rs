...
impl<O: IsA<CellRenderer>> CellRendererExt for O {
    ...
    fn get_alignment(&self) -> (f32, f32) {
        unsafe {
            ...
            gtk_sys::gtk_cell_renderer_get_alignment(self.as_ref().to_glib_none().0, xalign.as_mut_ptr(), yalign.as_mut_ptr());
    ...
    fn get_fixed_size(&self) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_cell_renderer_get_fixed_size(self.as_ref().to_glib_none().0, width.as_mut_ptr(), height.as_mut_ptr());
    ...
    fn get_padding(&self) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_cell_renderer_get_padding(self.as_ref().to_glib_none().0, xpad.as_mut_ptr(), ypad.as_mut_ptr());
    ...
    fn get_preferred_height<P: IsA<Widget>>(&self, widget: &P) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_cell_renderer_get_preferred_height(self.as_ref().to_glib_none().0, widget.as_ref().to_glib_none().0, minimum_size.as_mut_ptr(), natural_size.as_mut_ptr());
    ...
    fn get_preferred_height_for_width<P: IsA<Widget>>(&self, widget: &P, width: i32) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_cell_renderer_get_preferred_height_for_width(self.as_ref().to_glib_none().0, widget.as_ref().to_glib_none().0, width, minimum_height.as_mut_ptr(), natural_height.as_mut_ptr());
    ...
    fn get_preferred_width<P: IsA<Widget>>(&self, widget: &P) -> (i32, i32) {
        unsafe {
            let mut minimum_size = mem::MaybeUninit::uninit();
            let mut natural_size = mem::MaybeUninit::uninit();
            gtk_sys::gtk_cell_renderer_get_preferred_width(self.as_ref().to_glib_none().0, widget.as_ref().to_glib_none().0, minimum_size.as_mut_ptr(), natural_size.as_mut_ptr());
            let minimum_size = minimum_size.assume_init();
            let natural_size = natural_size.assume_init();
            (minimum_size, natural_size)
        }
    ...
    fn get_preferred_width_for_height<P: IsA<Widget>>(&self, widget: &P, height: i32) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_cell_renderer_get_preferred_width_for_height(self.as_ref().to_glib_none().0, widget.as_ref().to_glib_none().0, height, minimum_width.as_mut_ptr(), natural_width.as_mut_ptr());
    ...
    fn get_property_cell_background_set(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `cell-background-set` getter").unwrap()
        }
    }
    ...
    fn get_property_editing(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `editing` getter").unwrap()
        }
    }
    ...
    fn get_property_is_expanded(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `is-expanded` getter").unwrap()
        }
    }
    ...
    fn get_property_is_expander(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `is-expander` getter").unwrap()
        }
    }
    ...
    fn get_property_mode(&self) -> CellRendererMode {
        unsafe {
            ...
            value.get().expect("Return Value for property `mode` getter").unwrap()
        }
    }
