...
impl IconInfo {
    ...
    pub fn load_icon_async<P: IsA<gio::Cancellable>, Q: FnOnce(Result<gdk_pixbuf::Pixbuf, Error>) + Send + 'static>(&self, cancellable: Option<&P>, callback: Q) {
        ...
        unsafe {
            gtk_sys::gtk_icon_info_load_icon_async(self.to_glib_none().0, cancellable.map(|p| p.as_ref()).to_glib_none().0, Some(callback), Box_::into_raw(user_data) as *mut _);
        }
    }
    ...
    pub fn load_symbolic(&self, fg: &gdk::RGBA, success_color: Option<&gdk::RGBA>, warning_color: Option<&gdk::RGBA>, error_color: Option<&gdk::RGBA>) -> Result<(gdk_pixbuf::Pixbuf, bool), Error> {
        unsafe {
            ...
            let mut error = ptr::null_mut();
            let ret = gtk_sys::gtk_icon_info_load_symbolic(self.to_glib_none().0, fg.to_glib_none().0, success_color.to_glib_none().0, warning_color.to_glib_none().0, error_color.to_glib_none().0, was_symbolic.as_mut_ptr(), &mut error);
    ...
    pub fn load_symbolic_async<P: IsA<gio::Cancellable>, Q: FnOnce(Result<(gdk_pixbuf::Pixbuf, bool), Error>) + Send + 'static>(&self, fg: &gdk::RGBA, success_color: Option<&gdk::RGBA>, warning_color: Option<&gdk::RGBA>, error_color: Option<&gdk::RGBA>, cancellable: Option<&P>, callback: Q) {
        ...
        unsafe extern "C" fn load_symbolic_async_trampoline<Q: FnOnce(Result<(gdk_pixbuf::Pixbuf, bool), Error>) + Send + 'static>(_source_object: *mut gobject_sys::GObject, res: *mut gio_sys::GAsyncResult, user_data: glib_sys::gpointer) {
            let mut error = ptr::null_mut();
            let mut was_symbolic = mem::MaybeUninit::uninit();
            let ret = gtk_sys::gtk_icon_info_load_symbolic_finish(_source_object as *mut _, res, was_symbolic.as_mut_ptr(), &mut error);
            let was_symbolic = was_symbolic.assume_init();
        ...
        unsafe {
            gtk_sys::gtk_icon_info_load_symbolic_async(self.to_glib_none().0, fg.to_glib_none().0, success_color.to_glib_none().0, warning_color.to_glib_none().0, error_color.to_glib_none().0, cancellable.map(|p| p.as_ref()).to_glib_none().0, Some(callback), Box_::into_raw(user_data) as *mut _);
        }
    }
    ...
    pub fn load_symbolic_for_context<P: IsA<StyleContext>>(&self, context: &P) -> Result<(gdk_pixbuf::Pixbuf, bool), Error> {
        unsafe {
            let mut was_symbolic = mem::MaybeUninit::uninit();
            let mut error = ptr::null_mut();
            let ret = gtk_sys::gtk_icon_info_load_symbolic_for_context(self.to_glib_none().0, context.as_ref().to_glib_none().0, was_symbolic.as_mut_ptr(), &mut error);
            let was_symbolic = was_symbolic.assume_init();
            if error.is_null() { Ok((from_glib_full(ret), from_glib(was_symbolic))) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    pub fn load_symbolic_for_context_async<P: IsA<StyleContext>, Q: IsA<gio::Cancellable>, R: FnOnce(Result<(gdk_pixbuf::Pixbuf, bool), Error>) + Send + 'static>(&self, context: &P, cancellable: Option<&Q>, callback: R) {
        ...
        unsafe extern "C" fn load_symbolic_for_context_async_trampoline<R: FnOnce(Result<(gdk_pixbuf::Pixbuf, bool), Error>) + Send + 'static>(_source_object: *mut gobject_sys::GObject, res: *mut gio_sys::GAsyncResult, user_data: glib_sys::gpointer) {
            let mut error = ptr::null_mut();
            let mut was_symbolic = mem::MaybeUninit::uninit();
            let ret = gtk_sys::gtk_icon_info_load_symbolic_for_context_finish(_source_object as *mut _, res, was_symbolic.as_mut_ptr(), &mut error);
            let was_symbolic = was_symbolic.assume_init();
            let result = if error.is_null() { Ok((from_glib_full(ret), from_glib(was_symbolic))) } else { Err(from_glib_full(error)) };
        ...
        unsafe {
            gtk_sys::gtk_icon_info_load_symbolic_for_context_async(self.to_glib_none().0, context.as_ref().to_glib_none().0, cancellable.map(|p| p.as_ref()).to_glib_none().0, Some(callback), Box_::into_raw(user_data) as *mut _);
        }
    }
