...
impl<O: IsA<FlowBox>> FlowBoxExt for O {
    ...
    fn bind_model<P: IsA<gio::ListModel>, Q: Fn(&glib::Object) -> Widget + 'static>(&self, model: Option<&P>, create_widget_func: Q) {
        ...
        unsafe {
            gtk_sys::gtk_flow_box_bind_model(self.as_ref().to_glib_none().0, model.map(|p| p.as_ref()).to_glib_none().0, create_widget_func, Box_::into_raw(super_callback0) as *mut _, destroy_call4);
        }
    }
    ...
    fn set_filter_func(&self, filter_func: Option<Box_<dyn Fn(&FlowBoxChild) -> bool + 'static>>) {
        ...
        unsafe {
            gtk_sys::gtk_flow_box_set_filter_func(self.as_ref().to_glib_none().0, filter_func, Box_::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }
    ...
    fn set_sort_func(&self, sort_func: Option<Box_<dyn Fn(&FlowBoxChild, &FlowBoxChild) -> i32 + 'static>>) {
        ...
        unsafe {
            gtk_sys::gtk_flow_box_set_sort_func(self.as_ref().to_glib_none().0, sort_func, Box_::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }
