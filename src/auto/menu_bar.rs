...
impl<O: IsA<MenuBar>> MenuBarExt for O {
    fn get_child_pack_direction(&self) -> PackDirection {
        unsafe {
            ffi::gtk_menu_bar_get_child_pack_direction(self.to_glib_none().0)
        }
    }

    fn get_pack_direction(&self) -> PackDirection {
        unsafe {
            ffi::gtk_menu_bar_get_pack_direction(self.to_glib_none().0)
        }
    }

    fn set_child_pack_direction(&self, child_pack_dir: PackDirection) {
        unsafe {
            ffi::gtk_menu_bar_set_child_pack_direction(self.to_glib_none().0, child_pack_dir);
        }
    }

    fn set_pack_direction(&self, pack_dir: PackDirection) {
        unsafe {
            ffi::gtk_menu_bar_set_pack_direction(self.to_glib_none().0, pack_dir);
        }
    }
}
