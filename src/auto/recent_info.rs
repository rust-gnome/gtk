...
impl RecentInfo {
    ...
    pub fn get_application_info(&self, app_name: &str) -> Option<(GString, u32, libc::c_long)> {
        unsafe {
            ...
            let ret = from_glib(gtk_sys::gtk_recent_info_get_application_info(self.to_glib_none().0, app_name.to_glib_none().0, &mut app_exec, count.as_mut_ptr(), time_.as_mut_ptr()));
    ...
    pub fn get_applications(&self) -> Vec<GString> {
        unsafe {
            ...
            let ret = FromGlibContainer::from_glib_full_num(gtk_sys::gtk_recent_info_get_applications(self.to_glib_none().0, length.as_mut_ptr()), length.assume_init() as usize);
            ret
        }
    }
    ...
    pub fn get_groups(&self) -> Vec<GString> {
        unsafe {
            let mut length = mem::MaybeUninit::uninit();
            let ret = FromGlibContainer::from_glib_full_num(gtk_sys::gtk_recent_info_get_groups(self.to_glib_none().0, length.as_mut_ptr()), length.assume_init() as usize);
            ret
        }
    }
