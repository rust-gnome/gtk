...
impl<O: IsA<IMContext>> IMContextExt for O {
    ...
    fn get_preedit_string(&self) -> (GString, pango::AttrList, i32) {
        unsafe {
            ...
            gtk_sys::gtk_im_context_get_preedit_string(self.as_ref().to_glib_none().0, &mut str, &mut attrs, cursor_pos.as_mut_ptr());
    ...
    fn get_surrounding(&self) -> Option<(GString, i32)> {
        unsafe {
            ...
            let ret = from_glib(gtk_sys::gtk_im_context_get_surrounding(self.as_ref().to_glib_none().0, &mut text, cursor_index.as_mut_ptr()));
