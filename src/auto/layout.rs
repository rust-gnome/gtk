...
impl<O: IsA<Layout>> LayoutExt for O {
    ...
    fn get_size(&self) -> (u32, u32) {
        unsafe {
            ...
            gtk_sys::gtk_layout_get_size(self.as_ref().to_glib_none().0, width.as_mut_ptr(), height.as_mut_ptr());
    ...
    fn get_child_x<T: IsA<Widget>>(&self, item: &T) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `x` getter").unwrap()
        }
    }
    ...
    fn get_child_y<T: IsA<Widget>>(&self, item: &T) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `y` getter").unwrap()
        }
    }
