...
impl<O: IsA<Frame>> FrameExt for O {
    ...
    fn get_label_align(&self) -> (f32, f32) {
        unsafe {
            ...
            gtk_sys::gtk_frame_get_label_align(self.as_ref().to_glib_none().0, xalign.as_mut_ptr(), yalign.as_mut_ptr());
    ...
    fn get_property_label_xalign(&self) -> f32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `label-xalign` getter").unwrap()
        }
    }
    ...
    fn get_property_label_yalign(&self) -> f32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `label-yalign` getter").unwrap()
        }
    }
