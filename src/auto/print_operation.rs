...
impl<O: IsA<PrintOperation>> PrintOperationExt for O {
    ...
    fn get_property_allow_async(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `allow-async` getter").unwrap()
        }
    }
    ...
    fn get_property_current_page(&self) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `current-page` getter").unwrap()
        }
    }
    ...
    fn get_property_custom_tab_label(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `custom-tab-label` getter")
        }
    }
    ...
    fn get_property_export_filename(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `export-filename` getter")
        }
    }
    ...
    fn get_property_job_name(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `job-name` getter")
        }
    }
    ...
    fn get_property_n_pages(&self) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `n-pages` getter").unwrap()
        }
    }
    ...
    fn get_property_show_progress(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `show-progress` getter").unwrap()
        }
    }
    ...
    fn get_property_track_print_status(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `track-print-status` getter").unwrap()
        }
    }
    ...
    fn get_property_unit(&self) -> Unit {
        unsafe {
            ...
            value.get().expect("Return Value for property `unit` getter").unwrap()
        }
    }
    ...
    fn get_property_use_full_page(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `use-full-page` getter").unwrap()
        }
    }
