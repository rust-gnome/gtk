...
impl<O: IsA<LockButton>> LockButtonExt for O {
    ...
    fn get_property_text_lock(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `text-lock` getter")
        }
    }
    ...
    fn get_property_text_unlock(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `text-unlock` getter")
        }
    }
    ...
    fn get_property_tooltip_lock(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `tooltip-lock` getter")
        }
    }
    ...
    fn get_property_tooltip_not_authorized(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `tooltip-not-authorized` getter")
        }
    }
    ...
    fn get_property_tooltip_unlock(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `tooltip-unlock` getter")
        }
    }
