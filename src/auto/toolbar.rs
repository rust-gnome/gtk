...
impl<O: IsA<Toolbar>> ToolbarExt for O {
    ...
    fn get_property_icon_size_set(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `icon-size-set` getter").unwrap()
        }
    }
    ...
    fn get_property_toolbar_style(&self) -> ToolbarStyle {
        unsafe {
            ...
            value.get().expect("Return Value for property `toolbar-style` getter").unwrap()
        }
    }
    ...
    fn emit_focus_home_or_end(&self, focus_home: bool) -> bool {
        ...
        res.unwrap().get().expect("Return Value for `emit_focus_home_or_end`").unwrap()
    }
