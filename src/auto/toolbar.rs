...
impl<O: IsA<Toolbar> + IsA<Container> + IsA<glib::object::Object>> ToolbarExt for O {
    ...
    fn set_property_toolbar_style(&self, toolbar_style: ToolbarStyle) {
        let toolbar_style = toolbar_style as i32;
        unsafe {
...
where P: IsA<Toolbar> {
    ...
    f(&Toolbar::from_glib_none(this).downcast_unchecked(), orientation)
}
...
where P: IsA<Toolbar> {
    ...
    f(&Toolbar::from_glib_none(this).downcast_unchecked(), style)
}
