...
impl<O: IsA<TextView>> TextViewExt for O {
    ...
    fn buffer_to_window_coords(&self, win: TextWindowType, buffer_x: i32, buffer_y: i32) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_text_view_buffer_to_window_coords(self.as_ref().to_glib_none().0, win.to_glib(), buffer_x, buffer_y, window_x.as_mut_ptr(), window_y.as_mut_ptr());
    ...
    fn get_iter_at_position(&self, x: i32, y: i32) -> Option<(TextIter, i32)> {
        unsafe {
            ...
            let ret = from_glib(gtk_sys::gtk_text_view_get_iter_at_position(self.as_ref().to_glib_none().0, iter.to_glib_none_mut().0, trailing.as_mut_ptr(), x, y));
    ...
    fn get_line_at_y(&self, y: i32) -> (TextIter, i32) {
        unsafe {
            ...
            gtk_sys::gtk_text_view_get_line_at_y(self.as_ref().to_glib_none().0, target_iter.to_glib_none_mut().0, y, line_top.as_mut_ptr());
    ...
    fn get_line_yrange(&self, iter: &TextIter) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_text_view_get_line_yrange(self.as_ref().to_glib_none().0, iter.to_glib_none().0, y.as_mut_ptr(), height.as_mut_ptr());
            let y = y.assume_init();
    ...
    fn window_to_buffer_coords(&self, win: TextWindowType, window_x: i32, window_y: i32) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_text_view_window_to_buffer_coords(self.as_ref().to_glib_none().0, win.to_glib(), window_x, window_y, buffer_x.as_mut_ptr(), buffer_y.as_mut_ptr());
    ...
    fn get_property_monospace(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `monospace` getter").unwrap()
        }
    }
