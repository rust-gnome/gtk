...
where P: IsA<TextView> {
    ...
    f(&TextView::from_glib_none(this).downcast_unchecked(), type_, count)
}
...
where P: IsA<TextView> {
    ...
    f(&TextView::from_glib_none(this).downcast_unchecked(), granularity, &from_glib_none(location), &from_glib_none(start), &from_glib_none(end)).to_glib()
}
...
where P: IsA<TextView> {
    ...
    f(&TextView::from_glib_none(this).downcast_unchecked(), step, count, from_glib(extend_selection))
}
...
where P: IsA<TextView> {
    ...
    f(&TextView::from_glib_none(this).downcast_unchecked(), step, count)
}
