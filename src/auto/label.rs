...
impl<O: IsA<Label> + IsA<glib::object::Object>> LabelExt for O {
    ...
    fn get_ellipsize(&self) -> pango::EllipsizeMode {
        unsafe {
            ffi::gtk_label_get_ellipsize(self.to_glib_none().0)
        }
    }
    ...
    fn get_line_wrap_mode(&self) -> pango::WrapMode {
        unsafe {
            ffi::gtk_label_get_line_wrap_mode(self.to_glib_none().0)
        }
    }
    ...
    fn set_ellipsize(&self, mode: pango::EllipsizeMode) {
        unsafe {
            ffi::gtk_label_set_ellipsize(self.to_glib_none().0, mode);
        }
    }
    ...
    fn set_line_wrap_mode(&self, wrap_mode: pango::WrapMode) {
        unsafe {
            ffi::gtk_label_set_line_wrap_mode(self.to_glib_none().0, wrap_mode);
        }
    }
    ...
    fn set_property_wrap_mode(&self, wrap_mode: pango::WrapMode) {
        let wrap_mode = wrap_mode as i32;
        unsafe {
...
where P: IsA<Label> {
    ...
    f(&Label::from_glib_none(this).downcast_unchecked(), step, count, from_glib(extend_selection))
}
