...
impl<O: IsA<Label>> LabelExt for O {
    ...
    fn get_layout_offsets(&self) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_label_get_layout_offsets(self.as_ref().to_glib_none().0, x.as_mut_ptr(), y.as_mut_ptr());
            let x = x.assume_init();
            let y = y.assume_init();
            (x, y)
        }
    ...
    fn get_selection_bounds(&self) -> Option<(i32, i32)> {
        unsafe {
            ...
            let ret = from_glib(gtk_sys::gtk_label_get_selection_bounds(self.as_ref().to_glib_none().0, start.as_mut_ptr(), end.as_mut_ptr()));
    ...
    fn get_property_wrap(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `wrap` getter").unwrap()
        }
    }
