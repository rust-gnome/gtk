...
impl<O: IsA<TextBuffer>> TextBufferExt for O {
    ...
    fn get_deserialize_formats(&self) -> Vec<gdk::Atom> {
        unsafe {
            ...
            let ret = FromGlibContainer::from_glib_container_num(gtk_sys::gtk_text_buffer_get_deserialize_formats(self.as_ref().to_glib_none().0, n_formats.as_mut_ptr()), n_formats.assume_init() as usize);
            ret
        }
    }
    ...
    fn get_serialize_formats(&self) -> Vec<gdk::Atom> {
        unsafe {
            let mut n_formats = mem::MaybeUninit::uninit();
            let ret = FromGlibContainer::from_glib_container_num(gtk_sys::gtk_text_buffer_get_serialize_formats(self.as_ref().to_glib_none().0, n_formats.as_mut_ptr()), n_formats.assume_init() as usize);
            ret
        }
    }
    ...
    fn serialize<P: IsA<TextBuffer>>(&self, content_buffer: &P, format: &gdk::Atom, start: &TextIter, end: &TextIter) -> Vec<u8> {
        unsafe {
            ...
            let ret = FromGlibContainer::from_glib_full_num(gtk_sys::gtk_text_buffer_serialize(self.as_ref().to_glib_none().0, content_buffer.as_ref().to_glib_none().0, format.to_glib_none().0, start.to_glib_none().0, end.to_glib_none().0, length.as_mut_ptr()), length.assume_init() as usize);
            ret
        }
    }
