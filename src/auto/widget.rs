...
impl<O: IsA<Widget>> WidgetExt for O {
    ...
    fn get_allocated_size(&self) -> (Allocation, i32) {
        unsafe {
            ...
            gtk_sys::gtk_widget_get_allocated_size(self.as_ref().to_glib_none().0, allocation.to_glib_none_mut().0, baseline.as_mut_ptr());
    ...
    fn get_preferred_height(&self) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_widget_get_preferred_height(self.as_ref().to_glib_none().0, minimum_height.as_mut_ptr(), natural_height.as_mut_ptr());
    ...
    fn get_preferred_height_and_baseline_for_width(&self, width: i32) -> (i32, i32, i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_widget_get_preferred_height_and_baseline_for_width(self.as_ref().to_glib_none().0, width, minimum_height.as_mut_ptr(), natural_height.as_mut_ptr(), minimum_baseline.as_mut_ptr(), natural_baseline.as_mut_ptr());
            let minimum_height = minimum_height.assume_init();
            let natural_height = natural_height.assume_init();
    ...
    fn get_preferred_height_for_width(&self, width: i32) -> (i32, i32) {
        unsafe {
            let mut minimum_height = mem::MaybeUninit::uninit();
            let mut natural_height = mem::MaybeUninit::uninit();
            gtk_sys::gtk_widget_get_preferred_height_for_width(self.as_ref().to_glib_none().0, width, minimum_height.as_mut_ptr(), natural_height.as_mut_ptr());
            let minimum_height = minimum_height.assume_init();
            let natural_height = natural_height.assume_init();
            (minimum_height, natural_height)
        }
    ...
    fn get_preferred_width(&self) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_widget_get_preferred_width(self.as_ref().to_glib_none().0, minimum_width.as_mut_ptr(), natural_width.as_mut_ptr());
    ...
    fn get_preferred_width_for_height(&self, height: i32) -> (i32, i32) {
        unsafe {
            let mut minimum_width = mem::MaybeUninit::uninit();
            let mut natural_width = mem::MaybeUninit::uninit();
            gtk_sys::gtk_widget_get_preferred_width_for_height(self.as_ref().to_glib_none().0, height, minimum_width.as_mut_ptr(), natural_width.as_mut_ptr());
            let minimum_width = minimum_width.assume_init();
            let natural_width = natural_width.assume_init();
            (minimum_width, natural_width)
        }
    ...
    fn get_size_request(&self) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_widget_get_size_request(self.as_ref().to_glib_none().0, width.as_mut_ptr(), height.as_mut_ptr());
    ...
    fn translate_coordinates<P: IsA<Widget>>(&self, dest_widget: &P, src_x: i32, src_y: i32) -> Option<(i32, i32)> {
        unsafe {
            ...
            let ret = from_glib(gtk_sys::gtk_widget_translate_coordinates(self.as_ref().to_glib_none().0, dest_widget.as_ref().to_glib_none().0, src_x, src_y, dest_x.as_mut_ptr(), dest_y.as_mut_ptr()));
    ...
    fn get_property_composite_child(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `composite-child` getter").unwrap()
        }
    }
    ...
    fn get_property_expand(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `expand` getter").unwrap()
        }
    }
    ...
    fn get_property_has_default(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `has-default` getter").unwrap()
        }
    }
    ...
    fn get_property_has_focus(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `has-focus` getter").unwrap()
        }
    }
    ...
    fn get_property_height_request(&self) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `height-request` getter").unwrap()
        }
    }
    ...
    fn get_property_is_focus(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `is-focus` getter").unwrap()
        }
    }
    ...
    fn get_property_margin(&self) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `margin` getter").unwrap()
        }
    }
    ...
    fn get_property_width_request(&self) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `width-request` getter").unwrap()
        }
    }
    ...
    fn emit_popup_menu(&self) -> bool {
        ...
        res.unwrap().get().expect("Return Value for `emit_popup_menu`").unwrap()
    }
    ...
    fn emit_show_help(&self, help_type: WidgetHelpType) -> bool {
        ...
        res.unwrap().get().expect("Return Value for `emit_show_help`").unwrap()
    }
