...
impl<O: IsA<Widget> + IsA<glib::object::Object>> WidgetExt for O {
    ...
    fn add_device_events<P: IsA<gdk::Device>>(&self, device: &P, events: gdk::EventMask) {
        unsafe {
            ffi::gtk_widget_add_device_events(self.to_glib_none().0, device.to_glib_none().0, events);
        }
    }
    ...
    fn drag_begin<'a, P: Into<Option<&'a gdk::Event>>>(&self, targets: &TargetList, actions: gdk::DragAction, button: i32, event: P) -> Option<gdk::DragContext> {
        ...
        unsafe {
            from_glib_none(ffi::gtk_drag_begin(self.to_glib_none().0, targets.to_glib_none().0, actions, button, mut_override(event.to_glib_none().0)))
        }
    }
    ...
    fn drag_begin_with_coordinates<'a, P: Into<Option<&'a gdk::Event>>>(&self, targets: &TargetList, actions: gdk::DragAction, button: i32, event: P, x: i32, y: i32) -> Option<gdk::DragContext> {
        let event = event.into();
        unsafe {
            from_glib_none(ffi::gtk_drag_begin_with_coordinates(self.to_glib_none().0, targets.to_glib_none().0, actions, button, mut_override(event.to_glib_none().0), x, y))
        }
    }
    ...
    fn drag_dest_set_proxy(&self, proxy_window: &gdk::Window, protocol: gdk::DragProtocol, use_coordinates: bool) {
        unsafe {
            ffi::gtk_drag_dest_set_proxy(self.to_glib_none().0, proxy_window.to_glib_none().0, protocol, use_coordinates.to_glib());
        }
    }
    ...
    fn get_device_events<P: IsA<gdk::Device>>(&self, device: &P) -> gdk::EventMask {
        unsafe {
            ffi::gtk_widget_get_device_events(self.to_glib_none().0, device.to_glib_none().0)
        }
    }
    ...
    fn override_background_color<'a, P: Into<Option<&'a gdk::RGBA>>>(&self, state: StateFlags, color: P) {
        ...
        unsafe {
            ffi::gtk_widget_override_background_color(self.to_glib_none().0, state, color.0);
        }
    }
    ...
    fn override_color<'a, P: Into<Option<&'a gdk::RGBA>>>(&self, state: StateFlags, color: P) {
        ...
        let color = color.to_glib_none();
        unsafe {
            ffi::gtk_widget_override_color(self.to_glib_none().0, state, color.0);
        }
    }
    ...
    fn set_device_events<P: IsA<gdk::Device>>(&self, device: &P, events: gdk::EventMask) {
        unsafe {
            ffi::gtk_widget_set_device_events(self.to_glib_none().0, device.to_glib_none().0, events);
        }
    }
...
where P: IsA<Widget> {
    ...
    f(&Widget::from_glib_none(this).downcast_unchecked(), previous_direction)
}
...
where P: IsA<Widget> {
    ...
    f(&Widget::from_glib_none(this).downcast_unchecked(), &from_glib_none(context), result).to_glib()
}
