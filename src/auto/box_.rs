...
impl<O: IsA<Box>> BoxExt for O {
    ...
    fn query_child_packing<P: IsA<Widget>>(&self, child: &P) -> (bool, bool, u32, PackType) {
        unsafe {
            ...
            gtk_sys::gtk_box_query_child_packing(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, expand.as_mut_ptr(), fill.as_mut_ptr(), padding.as_mut_ptr(), pack_type.as_mut_ptr());
    ...
    fn get_child_fill<T: IsA<Widget>>(&self, item: &T) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `fill` getter").unwrap()
        }
    }
    ...
    fn get_child_pack_type<T: IsA<Widget>>(&self, item: &T) -> PackType {
        unsafe {
            ...
            value.get().expect("Return Value for property `pack-type` getter").unwrap()
        }
    }
    ...
    fn get_child_padding<T: IsA<Widget>>(&self, item: &T) -> u32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `padding` getter").unwrap()
        }
    }
