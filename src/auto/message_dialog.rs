...
impl<O: IsA<MessageDialog>> MessageDialogExt for O {
    ...
    fn get_property_message_type(&self) -> MessageType {
        unsafe {
            ...
            value.get().expect("Return Value for property `message-type` getter").unwrap()
        }
    }
    ...
    fn get_property_secondary_text(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `secondary-text` getter")
        }
    }
    ...
    fn get_property_secondary_use_markup(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `secondary-use-markup` getter").unwrap()
        }
    }
