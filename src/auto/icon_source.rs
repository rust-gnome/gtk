...
impl IconSource {
    ...
    pub fn get_direction(&self) -> TextDirection {
        unsafe {
            ffi::gtk_icon_source_get_direction(self.to_glib_none().0)
        }
    }
    ...
    pub fn get_state(&self) -> StateType {
        unsafe {
            ffi::gtk_icon_source_get_state(self.to_glib_none().0)
        }
    }
    ...
    pub fn set_direction(&mut self, direction: TextDirection) {
        unsafe {
            ffi::gtk_icon_source_set_direction(self.to_glib_none_mut().0, direction);
        }
    }
    ...
    pub fn set_state(&mut self, state: StateType) {
        unsafe {
            ffi::gtk_icon_source_set_state(self.to_glib_none_mut().0, state);
        }
    }
