...
impl<O: IsA<CellRendererProgress>> CellRendererProgressExt for O {
    ...
    fn get_property_pulse(&self) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `pulse` getter").unwrap()
        }
    }
    ...
    fn get_property_text_xalign(&self) -> f32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `text-xalign` getter").unwrap()
        }
    }
    ...
    fn get_property_text_yalign(&self) -> f32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `text-yalign` getter").unwrap()
        }
    }
    ...
    fn get_property_value(&self) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `value` getter").unwrap()
        }
    }
