...
pub trait CellRendererSpinExt: 'static {
    ...
    fn set_property_adjustment<P: IsA<Adjustment> + SetValueOptional>(&self, adjustment: Option<&P>);
...
impl<O: IsA<CellRendererSpin>> CellRendererSpinExt for O {
    fn get_property_adjustment(&self) -> Option<Adjustment> {
        unsafe {
            ...
            value.get().expect("Return Value for property `adjustment` getter")
        }
    }
    ...
    fn get_property_climb_rate(&self) -> f64 {
        unsafe {
            ...
            value.get().expect("Return Value for property `climb-rate` getter").unwrap()
        }
    }
    ...
    fn get_property_digits(&self) -> u32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `digits` getter").unwrap()
        }
    }
