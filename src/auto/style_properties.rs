...
impl<O: IsA<StyleProperties>> StylePropertiesExt for O {
    ...
    fn get_property(&self, property: &str, state: StateFlags) -> Option<glib::Value> {
        unsafe {
            ...
            let ret = from_glib(ffi::gtk_style_properties_get_property(self.to_glib_none().0, property.to_glib_none().0, state, value.to_glib_none_mut().0));
    ...
    fn set_property(&self, property: &str, state: StateFlags, value: &glib::Value) {
        unsafe {
            ffi::gtk_style_properties_set_property(self.to_glib_none().0, property.to_glib_none().0, state, value.to_glib_none().0);
        }
    }
    ...
    fn unset_property(&self, property: &str, state: StateFlags) {
        unsafe {
            ffi::gtk_style_properties_unset_property(self.to_glib_none().0, property.to_glib_none().0, state);
        }
    }
}
