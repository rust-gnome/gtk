...
impl StyleProperties {
    ...
    //pub fn lookup_property(property_name: &str, pspec: /*Ignored*/glib::ParamSpec) -> Option<Fn(GString, glib::Value, Error) -> bool + 'static> {
    //    unsafe { TODO: call ffi::gtk_style_properties_lookup_property() }
    //}

    //#[cfg_attr(feature = "v3_8", deprecated)]
    //pub fn register_property<P: Fn(GString, glib::Value, Error) -> bool + 'static, Q: Into<Option<P>>>(parse_func: Q, pspec: /*Ignored*/&glib::ParamSpec) {
