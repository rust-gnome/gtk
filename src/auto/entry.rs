...
pub trait EntryExt: 'static {
    ...
    fn set_property_primary_icon_gicon<P: IsA<gio::Icon> + SetValueOptional>(&self, primary_icon_gicon: Option<&P>);
    ...
    fn set_property_secondary_icon_gicon<P: IsA<gio::Icon> + SetValueOptional>(&self, secondary_icon_gicon: Option<&P>);
...
impl<O: IsA<Entry>> EntryExt for O {
    ...
    fn get_layout_offsets(&self) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_entry_get_layout_offsets(self.as_ref().to_glib_none().0, x.as_mut_ptr(), y.as_mut_ptr());
            let x = x.assume_init();
            let y = y.assume_init();
            (x, y)
        }
    ...
    fn get_property_caps_lock_warning(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `caps-lock-warning` getter").unwrap()
        }
    }
    ...
    fn get_property_cursor_position(&self) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `cursor-position` getter").unwrap()
        }
    }
    ...
    fn get_property_enable_emoji_completion(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `enable-emoji-completion` getter").unwrap()
        }
    }
    ...
    fn get_property_im_module(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `im-module` getter")
        }
    }
    ...
    fn get_property_invisible_char_set(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `invisible-char-set` getter").unwrap()
        }
    }
    ...
    fn get_property_populate_all(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `populate-all` getter").unwrap()
        }
    }
    ...
    fn get_property_primary_icon_activatable(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `primary-icon-activatable` getter").unwrap()
        }
    }
    ...
    fn get_property_primary_icon_name(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `primary-icon-name` getter")
        }
    }
    ...
    fn get_property_primary_icon_pixbuf(&self) -> Option<gdk_pixbuf::Pixbuf> {
        unsafe {
            ...
            value.get().expect("Return Value for property `primary-icon-pixbuf` getter")
        }
    }
    ...
    fn get_property_primary_icon_sensitive(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `primary-icon-sensitive` getter").unwrap()
        }
    }
    ...
    fn get_property_primary_icon_storage_type(&self) -> ImageType {
        unsafe {
            ...
            value.get().expect("Return Value for property `primary-icon-storage-type` getter").unwrap()
        }
    }
    ...
    fn get_property_primary_icon_tooltip_markup(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `primary-icon-tooltip-markup` getter")
        }
    }
    ...
    fn get_property_primary_icon_tooltip_text(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `primary-icon-tooltip-text` getter")
        }
    }
    ...
    fn get_property_scroll_offset(&self) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `scroll-offset` getter").unwrap()
        }
    }
    ...
    fn get_property_secondary_icon_activatable(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `secondary-icon-activatable` getter").unwrap()
        }
    }
    ...
    fn get_property_secondary_icon_name(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `secondary-icon-name` getter")
        }
    }
    ...
    fn get_property_secondary_icon_pixbuf(&self) -> Option<gdk_pixbuf::Pixbuf> {
        unsafe {
            ...
            value.get().expect("Return Value for property `secondary-icon-pixbuf` getter")
        }
    }
    ...
    fn get_property_secondary_icon_sensitive(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `secondary-icon-sensitive` getter").unwrap()
        }
    }
    ...
    fn get_property_secondary_icon_storage_type(&self) -> ImageType {
        unsafe {
            ...
            value.get().expect("Return Value for property `secondary-icon-storage-type` getter").unwrap()
        }
    }
    ...
    fn get_property_secondary_icon_tooltip_markup(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `secondary-icon-tooltip-markup` getter")
        }
    }
    ...
    fn get_property_secondary_icon_tooltip_text(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `secondary-icon-tooltip-text` getter")
        }
    }
    ...
    fn get_property_selection_bound(&self) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `selection-bound` getter").unwrap()
        }
    }
    ...
    fn get_property_shadow_type(&self) -> ShadowType {
        unsafe {
            ...
            value.get().expect("Return Value for property `shadow-type` getter").unwrap()
        }
    }
    ...
    fn get_property_show_emoji_icon(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `show-emoji-icon` getter").unwrap()
        }
    }
    ...
    fn get_property_truncate_multiline(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `truncate-multiline` getter").unwrap()
        }
    }
