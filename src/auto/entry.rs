...
impl<O: IsA<Entry> + IsA<glib::object::Object>> EntryExt for O {
    ...
    fn get_icon_gicon(&self, icon_pos: EntryIconPosition) -> Option<gio::Icon> {
        unsafe {
            from_glib_none(ffi::gtk_entry_get_icon_gicon(self.to_glib_none().0, icon_pos))
        }
    }
    ...
    fn set_icon_drag_source(&self, icon_pos: EntryIconPosition, target_list: &TargetList, actions: gdk::DragAction) {
        unsafe {
            ffi::gtk_entry_set_icon_drag_source(self.to_glib_none().0, icon_pos, target_list.to_glib_none().0, actions);
        }
    }
    ...
    fn set_icon_from_gicon<'a, P: IsA<gio::Icon> + 'a, Q: Into<Option<&'a P>>>(&self, icon_pos: EntryIconPosition, icon: Q) {
        ...
        unsafe {
            ffi::gtk_entry_set_icon_from_gicon(self.to_glib_none().0, icon_pos, icon.0);
        }
    }
    ...
    fn set_icon_from_icon_name<'a, P: Into<Option<&'a str>>>(&self, icon_pos: EntryIconPosition, icon_name: P) {
        ...
        unsafe {
            ffi::gtk_entry_set_icon_from_icon_name(self.to_glib_none().0, icon_pos, icon_name.0);
        }
    }
    ...
    fn set_icon_from_pixbuf<'a, P: Into<Option<&'a gdk_pixbuf::Pixbuf>>>(&self, icon_pos: EntryIconPosition, pixbuf: P) {
        ...
        unsafe {
            ffi::gtk_entry_set_icon_from_pixbuf(self.to_glib_none().0, icon_pos, pixbuf.0);
        }
    }
    ...
    fn set_icon_from_stock<'a, P: Into<Option<&'a str>>>(&self, icon_pos: EntryIconPosition, stock_id: P) {
        ...
        unsafe {
            ffi::gtk_entry_set_icon_from_stock(self.to_glib_none().0, icon_pos, stock_id.0);
        }
    }
    ...
    fn set_icon_tooltip_markup<'a, P: Into<Option<&'a str>>>(&self, icon_pos: EntryIconPosition, tooltip: P) {
        ...
        unsafe {
            ffi::gtk_entry_set_icon_tooltip_markup(self.to_glib_none().0, icon_pos, tooltip.0);
        }
    }
    ...
    fn set_icon_tooltip_text<'a, P: Into<Option<&'a str>>>(&self, icon_pos: EntryIconPosition, tooltip: P) {
        ...
        let tooltip = tooltip.to_glib_none();
        unsafe {
            ffi::gtk_entry_set_icon_tooltip_text(self.to_glib_none().0, icon_pos, tooltip.0);
        }
    }
    ...
    fn set_property_shadow_type(&self, shadow_type: ShadowType) {
        let shadow_type = shadow_type as i32;
        unsafe {
...
where P: IsA<Entry> {
    ...
    f(&Entry::from_glib_none(this).downcast_unchecked(), type_, count)
}
...
where P: IsA<Entry> {
    ...
    f(&Entry::from_glib_none(this).downcast_unchecked(), icon_pos, &from_glib_none(event))
}
...
where P: IsA<Entry> {
    ...
    f(&Entry::from_glib_none(this).downcast_unchecked(), step, count, from_glib(extend_selection))
}
