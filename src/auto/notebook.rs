...
impl<O: IsA<Notebook>> NotebookExt for O {
    ...
    fn get_property_enable_popup(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `enable-popup` getter").unwrap()
        }
    }
    ...
    fn get_property_page(&self) -> i32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `page` getter").unwrap()
        }
    }
    ...
    fn get_child_detachable<T: IsA<Widget>>(&self, item: &T) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `detachable` getter").unwrap()
        }
    }
    ...
    fn get_child_menu_label<T: IsA<Widget>>(&self, item: &T) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `menu-label` getter")
        }
    }
    ...
    fn get_child_reorderable<T: IsA<Widget>>(&self, item: &T) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `reorderable` getter").unwrap()
        }
    }
    ...
    fn get_child_tab_expand<T: IsA<Widget>>(&self, item: &T) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `tab-expand` getter").unwrap()
        }
    }
    ...
    fn get_child_tab_fill<T: IsA<Widget>>(&self, item: &T) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `tab-fill` getter").unwrap()
        }
    }
    ...
    fn get_child_tab_label<T: IsA<Widget>>(&self, item: &T) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `tab-label` getter")
        }
    }
    ...
    fn emit_change_current_page(&self, object: i32) -> bool {
        ...
        res.unwrap().get().expect("Return Value for `emit_change_current_page`").unwrap()
    }
    ...
    fn emit_focus_tab(&self, object: NotebookTab) -> bool {
        ...
        res.unwrap().get().expect("Return Value for `emit_focus_tab`").unwrap()
    }
    ...
    fn emit_reorder_tab(&self, object: DirectionType, p0: bool) -> bool {
        ...
        res.unwrap().get().expect("Return Value for `emit_reorder_tab`").unwrap()
    }
    ...
    fn emit_select_page(&self, object: bool) -> bool {
        ...
        res.unwrap().get().expect("Return Value for `emit_select_page`").unwrap()
    }
