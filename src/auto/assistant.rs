...
impl<O: IsA<Assistant> + IsA<Container> + IsA<glib::object::Object>> AssistantExt for O {
    ...
    fn get_page_type<P: IsA<Widget>>(&self, page: &P) -> AssistantPageType {
        unsafe {
            ffi::gtk_assistant_get_page_type(self.to_glib_none().0, page.to_glib_none().0)
        }
    }
    ...
    fn set_page_type<P: IsA<Widget>>(&self, page: &P, type_: AssistantPageType) {
        unsafe {
            ffi::gtk_assistant_set_page_type(self.to_glib_none().0, page.to_glib_none().0, type_);
        }
    }
    ...
    fn set_child_page_type<T: IsA<Widget>>(&self, item: &T, page_type: AssistantPageType) {
        let page_type = page_type as i32;
        unsafe {
