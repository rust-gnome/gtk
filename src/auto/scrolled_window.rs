...
impl<O: IsA<ScrolledWindow>> ScrolledWindowExt for O {
    ...
    fn get_policy(&self) -> (PolicyType, PolicyType) {
        unsafe {
            ...
            gtk_sys::gtk_scrolled_window_get_policy(self.as_ref().to_glib_none().0, hscrollbar_policy.as_mut_ptr(), vscrollbar_policy.as_mut_ptr());
    ...
    fn get_property_hscrollbar_policy(&self) -> PolicyType {
        unsafe {
            ...
            value.get().expect("Return Value for property `hscrollbar-policy` getter").unwrap()
        }
    }
    ...
    fn get_property_vscrollbar_policy(&self) -> PolicyType {
        unsafe {
            ...
            value.get().expect("Return Value for property `vscrollbar-policy` getter").unwrap()
        }
    }
    ...
    fn get_property_window_placement(&self) -> CornerType {
        unsafe {
            ...
            value.get().expect("Return Value for property `window-placement` getter").unwrap()
        }
    }
    ...
    fn emit_scroll_child(&self, scroll: ScrollType, horizontal: bool) -> bool {
        ...
        res.unwrap().get().expect("Return Value for `emit_scroll_child`").unwrap()
    }
