...
impl<O: IsA<ScrolledWindow> + IsA<glib::object::Object>> ScrolledWindowExt for O {
    ...
    fn set_property_hscrollbar_policy(&self, hscrollbar_policy: PolicyType) {
        let hscrollbar_policy = hscrollbar_policy as i32;
        unsafe {
    ...
    fn set_property_vscrollbar_policy(&self, vscrollbar_policy: PolicyType) {
        let vscrollbar_policy = vscrollbar_policy as i32;
        unsafe {
    ...
    fn set_property_window_placement(&self, window_placement: CornerType) {
        let window_placement = window_placement as i32;
        unsafe {
...
where P: IsA<ScrolledWindow> {
    ...
    f(&ScrolledWindow::from_glib_none(this).downcast_unchecked(), pos)
}
...
where P: IsA<ScrolledWindow> {
    ...
    f(&ScrolledWindow::from_glib_none(this).downcast_unchecked(), direction_type)
}
...
where P: IsA<ScrolledWindow> {
    ...
    f(&ScrolledWindow::from_glib_none(this).downcast_unchecked(), scroll, from_glib(horizontal)).to_glib()
}
