...
pub trait GtkWindowExt: 'static {
    ...
    fn set_geometry_hints<P: IsA<Widget>>(&self, geometry_widget: Option<&P>, geometry: Option<&gdk::Geometry>, geom_mask: gdk::WindowHints);
...
impl<O: IsA<Window>> GtkWindowExt for O {
    ...
    fn get_default_size(&self) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_window_get_default_size(self.as_ref().to_glib_none().0, width.as_mut_ptr(), height.as_mut_ptr());
    ...
    fn get_position(&self) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_window_get_position(self.as_ref().to_glib_none().0, root_x.as_mut_ptr(), root_y.as_mut_ptr());
    ...
    fn get_size(&self) -> (i32, i32) {
        unsafe {
            let mut width = mem::MaybeUninit::uninit();
            let mut height = mem::MaybeUninit::uninit();
            gtk_sys::gtk_window_get_size(self.as_ref().to_glib_none().0, width.as_mut_ptr(), height.as_mut_ptr());
            let width = width.assume_init();
            let height = height.assume_init();
            (width, height)
        }
    ...
    fn set_geometry_hints<P: IsA<Widget>>(&self, geometry_widget: Option<&P>, geometry: Option<&gdk::Geometry>, geom_mask: gdk::WindowHints) {
        unsafe {
            gtk_sys::gtk_window_set_geometry_hints(self.as_ref().to_glib_none().0, geometry_widget.map(|p| p.as_ref()).to_glib_none().0, mut_override(geometry.to_glib_none().0), geom_mask.to_glib());
        }
    }
