...
impl Clipboard {
    ...
    pub fn request_contents<P: FnOnce(&Clipboard, &SelectionData) + 'static>(&self, target: &gdk::Atom, callback: P) {
        ...
        unsafe {
            gtk_sys::gtk_clipboard_request_contents(self.to_glib_none().0, target.to_glib_none().0, callback, Box_::into_raw(super_callback0) as *mut _);
        }
    }
    ...
    pub fn request_image<P: FnOnce(&Clipboard, &gdk_pixbuf::Pixbuf) + 'static>(&self, callback: P) {
        ...
        let super_callback0: Box_<P> = callback_data;
        unsafe {
            gtk_sys::gtk_clipboard_request_image(self.to_glib_none().0, callback, Box_::into_raw(super_callback0) as *mut _);
        }
    }
    ...
    pub fn request_rich_text<P: IsA<TextBuffer>, Q: FnOnce(&Clipboard, &gdk::Atom, Option<&str>, usize) + 'static>(&self, buffer: &P, callback: Q) {
        ...
        unsafe {
            gtk_sys::gtk_clipboard_request_rich_text(self.to_glib_none().0, buffer.as_ref().to_glib_none().0, callback, Box_::into_raw(super_callback0) as *mut _);
        }
    }
    ...
    pub fn request_text<P: FnOnce(&Clipboard, Option<&str>) + 'static>(&self, callback: P) {
        ...
        let super_callback0: Box_<P> = callback_data;
        unsafe {
            gtk_sys::gtk_clipboard_request_text(self.to_glib_none().0, callback, Box_::into_raw(super_callback0) as *mut _);
        }
    }
    ...
    pub fn wait_for_rich_text<P: IsA<TextBuffer>>(&self, buffer: &P) -> (Vec<u8>, gdk::Atom) {
        unsafe {
            ...
            let ret = FromGlibContainer::from_glib_full_num(gtk_sys::gtk_clipboard_wait_for_rich_text(self.to_glib_none().0, buffer.as_ref().to_glib_none().0, format.to_glib_none_mut().0, length.as_mut_ptr()), length.assume_init() as usize);
            (ret, format)
        }
    }
    ...
    pub fn wait_for_targets(&self) -> Option<Vec<gdk::Atom>> {
        unsafe {
            ...
            let ret = from_glib(gtk_sys::gtk_clipboard_wait_for_targets(self.to_glib_none().0, &mut targets, n_targets.as_mut_ptr()));
            if ret { Some(FromGlibContainer::from_glib_container_num(targets, n_targets.assume_init() as usize)) } else { None }
        }
    }
