...
impl<O: IsA<TreeSelection>> TreeSelectionExt for O {
    fn count_selected_rows(&self) -> i32 {
        unsafe {
            gtk_sys::gtk_tree_selection_count_selected_rows(self.as_ref().to_glib_none().0)
        }
    }

    fn get_mode(&self) -> SelectionMode {
        unsafe {
            from_glib(gtk_sys::gtk_tree_selection_get_mode(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn get_selected(&self) -> Option<(TreeModel, TreeIter)> {
        unsafe {
            ...
            let ret = from_glib(gtk_sys::gtk_tree_selection_get_selected(self.as_ref().to_glib_none().0, &mut model, iter.to_glib_none_mut().0));
    ...
    fn get_selected_rows(&self) -> (Vec<TreePath>, TreeModel) {
        unsafe {
            let mut model = ptr::null_mut();
            let ret = FromGlibPtrContainer::from_glib_full(gtk_sys::gtk_tree_selection_get_selected_rows(self.as_ref().to_glib_none().0, &mut model));
    ...
    fn get_tree_view(&self) -> Option<TreeView> {
        unsafe {
            from_glib_none(gtk_sys::gtk_tree_selection_get_tree_view(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn selected_foreach<P: FnMut(&TreeModel, &TreePath, &TreeIter)>(&self, func: P) {
        ...
        unsafe extern "C" fn func_func<P: FnMut(&TreeModel, &TreePath, &TreeIter)>(model: *mut gtk_sys::GtkTreeModel, path: *mut gtk_sys::GtkTreePath, iter: *mut gtk_sys::GtkTreeIter, data: glib_sys::gpointer) {
        ...
        unsafe {
            gtk_sys::gtk_tree_selection_selected_foreach(self.as_ref().to_glib_none().0, func, super_callback0 as *const _ as usize as *mut _);
        }
    }
    ...
    fn set_select_function(&self, func: Option<Box_<dyn Fn(&TreeSelection, &TreeModel, &TreePath, bool) -> bool + 'static>>) {
        ...
        unsafe extern "C" fn func_func(selection: *mut gtk_sys::GtkTreeSelection, model: *mut gtk_sys::GtkTreeModel, path: *mut gtk_sys::GtkTreePath, path_currently_selected: glib_sys::gboolean, data: glib_sys::gpointer) -> glib_sys::gboolean {
        ...
        unsafe {
            gtk_sys::gtk_tree_selection_set_select_function(self.as_ref().to_glib_none().0, func, Box_::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }
    ...
    fn connect_changed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn changed_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkTreeSelection, f: glib_sys::gpointer)
    ...
    fn connect_property_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_mode_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkTreeSelection, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<TreeSelection>
        {
            let f: &F = &*(f as *const F);
            f(&TreeSelection::from_glib_borrow(this).unsafe_cast())
