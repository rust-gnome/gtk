...
impl ImageBuilder {
    ...
    pub fn pixbuf_animation<P: IsA<gdk_pixbuf::PixbufAnimation>>(mut self, pixbuf_animation: &P) -> Self {
...
pub trait ImageExt: 'static {
    ...
    fn set_property_pixbuf_animation<P: IsA<gdk_pixbuf::PixbufAnimation> + SetValueOptional>(&self, pixbuf_animation: Option<&P>);
...
impl<O: IsA<Image>> ImageExt for O {
    ...
    fn get_gicon(&self) -> (gio::Icon, IconSize) {
        unsafe {
            ...
            gtk_sys::gtk_image_get_gicon(self.as_ref().to_glib_none().0, &mut gicon, size.as_mut_ptr());
    ...
    fn get_property_file(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `file` getter")
        }
    }
    ...
    fn get_property_pixbuf_animation(&self) -> Option<gdk_pixbuf::PixbufAnimation> {
        unsafe {
            ...
            value.get().expect("Return Value for property `pixbuf-animation` getter")
        }
    }
    ...
    fn get_property_resource(&self) -> Option<GString> {
        unsafe {
            ...
            value.get().expect("Return Value for property `resource` getter")
        }
    }
    ...
    fn get_property_use_fallback(&self) -> bool {
        unsafe {
            ...
            value.get().expect("Return Value for property `use-fallback` getter").unwrap()
        }
    }
