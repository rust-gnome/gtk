...
impl<O: IsA<TreeView>> TreeViewExt for O {
    ...
    fn convert_bin_window_to_tree_coords(&self, bx: i32, by: i32) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_tree_view_convert_bin_window_to_tree_coords(self.as_ref().to_glib_none().0, bx, by, tx.as_mut_ptr(), ty.as_mut_ptr());
    ...
    fn convert_bin_window_to_widget_coords(&self, bx: i32, by: i32) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_tree_view_convert_bin_window_to_widget_coords(self.as_ref().to_glib_none().0, bx, by, wx.as_mut_ptr(), wy.as_mut_ptr());
    ...
    fn convert_tree_to_bin_window_coords(&self, tx: i32, ty: i32) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_tree_view_convert_tree_to_bin_window_coords(self.as_ref().to_glib_none().0, tx, ty, bx.as_mut_ptr(), by.as_mut_ptr());
    ...
    fn convert_tree_to_widget_coords(&self, tx: i32, ty: i32) -> (i32, i32) {
        unsafe {
            let mut wx = mem::MaybeUninit::uninit();
            let mut wy = mem::MaybeUninit::uninit();
            gtk_sys::gtk_tree_view_convert_tree_to_widget_coords(self.as_ref().to_glib_none().0, tx, ty, wx.as_mut_ptr(), wy.as_mut_ptr());
            let wx = wx.assume_init();
            let wy = wy.assume_init();
            (wx, wy)
        }
    ...
    fn convert_widget_to_bin_window_coords(&self, wx: i32, wy: i32) -> (i32, i32) {
        unsafe {
            let mut bx = mem::MaybeUninit::uninit();
            let mut by = mem::MaybeUninit::uninit();
            gtk_sys::gtk_tree_view_convert_widget_to_bin_window_coords(self.as_ref().to_glib_none().0, wx, wy, bx.as_mut_ptr(), by.as_mut_ptr());
            let bx = bx.assume_init();
            let by = by.assume_init();
            (bx, by)
        }
    ...
    fn convert_widget_to_tree_coords(&self, wx: i32, wy: i32) -> (i32, i32) {
        unsafe {
            let mut tx = mem::MaybeUninit::uninit();
            let mut ty = mem::MaybeUninit::uninit();
            gtk_sys::gtk_tree_view_convert_widget_to_tree_coords(self.as_ref().to_glib_none().0, wx, wy, tx.as_mut_ptr(), ty.as_mut_ptr());
            let tx = tx.assume_init();
            let ty = ty.assume_init();
            (tx, ty)
        }
    ...
    fn get_dest_row_at_pos(&self, drag_x: i32, drag_y: i32) -> Option<(Option<TreePath>, TreeViewDropPosition)> {
        unsafe {
            ...
            let ret = from_glib(gtk_sys::gtk_tree_view_get_dest_row_at_pos(self.as_ref().to_glib_none().0, drag_x, drag_y, &mut path, pos.as_mut_ptr()));
    ...
    fn get_drag_dest_row(&self) -> (Option<TreePath>, TreeViewDropPosition) {
        unsafe {
            let mut path = ptr::null_mut();
            let mut pos = mem::MaybeUninit::uninit();
            gtk_sys::gtk_tree_view_get_drag_dest_row(self.as_ref().to_glib_none().0, &mut path, pos.as_mut_ptr());
            let pos = pos.assume_init();
    ...
    fn get_path_at_pos(&self, x: i32, y: i32) -> Option<(Option<TreePath>, Option<TreeViewColumn>, i32, i32)> {
        unsafe {
            ...
            let ret = from_glib(gtk_sys::gtk_tree_view_get_path_at_pos(self.as_ref().to_glib_none().0, x, y, &mut path, &mut column, cell_x.as_mut_ptr(), cell_y.as_mut_ptr()));
    ...
    fn insert_column_with_data_func<P: IsA<CellRenderer>, Q: Fn(&TreeViewColumn, &CellRenderer, &TreeModel, &TreeIter) + 'static>(&self, position: i32, title: &str, cell: &P, func: Q) -> i32 {
        ...
        unsafe {
            gtk_sys::gtk_tree_view_insert_column_with_data_func(self.as_ref().to_glib_none().0, position, title.to_glib_none().0, cell.as_ref().to_glib_none().0, func, Box_::into_raw(super_callback0) as *mut _, destroy_call6)
        }
    }
    ...
    fn is_blank_at_pos(&self, x: i32, y: i32) -> Option<(Option<TreePath>, Option<TreeViewColumn>, i32, i32)> {
        unsafe {
            ...
            let mut cell_x = mem::MaybeUninit::uninit();
            let mut cell_y = mem::MaybeUninit::uninit();
            let ret = from_glib(gtk_sys::gtk_tree_view_is_blank_at_pos(self.as_ref().to_glib_none().0, x, y, &mut path, &mut column, cell_x.as_mut_ptr(), cell_y.as_mut_ptr()));
            let cell_x = cell_x.assume_init();
            let cell_y = cell_y.assume_init();
            if ret { Some((from_glib_full(path), from_glib_none(column), cell_x, cell_y)) } else { None }
        }
    ...
    fn set_column_drag_function(&self, func: Option<Box_<dyn Fn(&TreeView, &TreeViewColumn, &TreeViewColumn, &TreeViewColumn) -> bool + 'static>>) {
        ...
        unsafe {
            gtk_sys::gtk_tree_view_set_column_drag_function(self.as_ref().to_glib_none().0, func, Box_::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }
    ...
    fn set_row_separator_func(&self, func: Option<Box_<dyn Fn(&TreeModel, &TreeIter) -> bool + 'static>>) {
        ...
        unsafe {
            gtk_sys::gtk_tree_view_set_row_separator_func(self.as_ref().to_glib_none().0, func, Box_::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }
    ...
    fn set_search_equal_func<P: Fn(&TreeModel, i32, &str, &TreeIter) -> bool + 'static>(&self, search_equal_func: P) {
        ...
        unsafe {
            gtk_sys::gtk_tree_view_set_search_equal_func(self.as_ref().to_glib_none().0, search_equal_func, Box_::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }
    ...
    fn set_search_position_func(&self, func: Option<Box_<dyn Fn(&TreeView, &Widget) + 'static>>) {
        ...
        unsafe {
            gtk_sys::gtk_tree_view_set_search_position_func(self.as_ref().to_glib_none().0, func, Box_::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }
    ...
    fn get_property_enable_grid_lines(&self) -> TreeViewGridLines {
        unsafe {
            ...
            value.get().expect("Return Value for property `enable-grid-lines` getter").unwrap()
        }
    }
    ...
    fn emit_expand_collapse_cursor_row(&self, object: bool, p0: bool, p1: bool) -> bool {
        ...
        res.unwrap().get().expect("Return Value for `emit_expand_collapse_cursor_row`").unwrap()
    }
    ...
    fn emit_move_cursor(&self, step: MovementStep, direction: i32) -> bool {
        ...
        res.unwrap().get().expect("Return Value for `emit_move_cursor`").unwrap()
    }
    ...
    fn emit_select_all(&self) -> bool {
        ...
        res.unwrap().get().expect("Return Value for `emit_select_all`").unwrap()
    }
    ...
    fn emit_select_cursor_parent(&self) -> bool {
        ...
        res.unwrap().get().expect("Return Value for `emit_select_cursor_parent`").unwrap()
    }
    ...
    fn emit_select_cursor_row(&self, object: bool) -> bool {
        ...
        res.unwrap().get().expect("Return Value for `emit_select_cursor_row`").unwrap()
    }
    ...
    fn emit_start_interactive_search(&self) -> bool {
        ...
        res.unwrap().get().expect("Return Value for `emit_start_interactive_search`").unwrap()
    }
    ...
    fn emit_toggle_cursor_row(&self) -> bool {
        ...
        res.unwrap().get().expect("Return Value for `emit_toggle_cursor_row`").unwrap()
    }
    ...
    fn emit_unselect_all(&self) -> bool {
        ...
        res.unwrap().get().expect("Return Value for `emit_unselect_all`").unwrap()
    }
