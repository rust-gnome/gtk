...
impl<O: IsA<CellRendererAccel>> CellRendererAccelExt for O {
    fn get_property_accel_key(&self) -> u32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `accel-key` getter").unwrap()
        }
    }
    ...
    fn get_property_accel_mode(&self) -> CellRendererAccelMode {
        unsafe {
            ...
            value.get().expect("Return Value for property `accel-mode` getter").unwrap()
        }
    }
    ...
    fn get_property_keycode(&self) -> u32 {
        unsafe {
            ...
            value.get().expect("Return Value for property `keycode` getter").unwrap()
        }
    }
