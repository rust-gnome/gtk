...
impl<W: Upcast<Widget>> WidgetTrait for W {
    ...
    fn reparent<T: Upcast<Widget>>(&self, new_parent: &T) {
        unsafe { ffi::gtk_widget_reparent(self.upcast().to_glib_none().0, new_parent.upcast().to_glib_none().0) }
    }
    ...
    fn set_sensitive(&self, sensitive: bool) {
        unsafe { ffi::gtk_widget_set_sensitive(self.upcast().to_glib_none().0, sensitive.to_glib()) }
    }

    fn set_parent<T: Upcast<Widget>>(&self, parent: &T) {
        unsafe { ffi::gtk_widget_set_parent(self.upcast().to_glib_none().0, parent.upcast().to_glib_none().0) }
    }

    /*
    fn set_parent_window<T: Upcast<Widget>>(&self, parent: &T) {
        unsafe { ffi::gtk_widget_set_parent_window(self.upcast().to_glib_none().0, parent.upcast().to_glib_none().0) }
    }
    */
    ...
    fn is_ancestor<T: Upcast<Widget>>(&self, ancestor: &T) -> bool {
        unsafe { from_glib(ffi::gtk_widget_is_ancestor(self.upcast().to_glib_none().0, ancestor.upcast().to_glib_none().0)) }
    }
    ...
    fn translate_coordinates<T: Upcast<Widget>>(&self, dest_widget: &T, src_x: i32, src_y: i32) -> Option<(i32, i32)> {
        ...
        let r = from_glib(unsafe { ffi::gtk_widget_translate_coordinates(self.upcast().to_glib_none().0, dest_widget.upcast().to_glib_none().0, src_x, src_y, &mut dest_x, &mut dest_y) });
        if r {
            Some((dest_x, dest_y))
        }
        else {
    ...
    fn override_background_color(&self, state: ::StateFlags, color: &gdk_ffi::C_GdkRGBA) {
        unsafe { ffi::gtk_widget_override_background_color(self.upcast().to_glib_none().0, state, color) }
    }
    ...
    fn override_symbolic_color(&self, name: &str, color: &gdk_ffi::C_GdkRGBA) {
        unsafe { ffi::gtk_widget_override_symbolic_color(self.upcast().to_glib_none().0, name.to_glib_none().0, color); }
    }

    fn override_cursor(&self, cursor: &gdk_ffi::C_GdkRGBA, secondary_cursor: &gdk_ffi::C_GdkRGBA) {
        unsafe { ffi::gtk_widget_override_cursor(self.upcast().to_glib_none().0, cursor, secondary_cursor) }
    }

    fn queue_draw_area(&self, x: i32, y: i32, width: i32, height: i32) {
        unsafe { ffi::gtk_widget_queue_draw_area(self.upcast().to_glib_none().0, x, y, width, height) }
    }

    fn set_app_paintable(&self, app_paintable: bool) {
        unsafe { ffi::gtk_widget_set_app_paintable(self.upcast().to_glib_none().0, app_paintable.to_glib()) }
    }

    fn set_double_buffered(&self, double_buffered: bool) {
        unsafe { ffi::gtk_widget_set_double_buffered(self.upcast().to_glib_none().0, double_buffered.to_glib()) }
    }

    fn set_redraw_on_allocate(&self, redraw_on_allocate: bool) {
        unsafe { ffi::gtk_widget_set_redraw_on_allocate(self.upcast().to_glib_none().0, redraw_on_allocate.to_glib()) }
    }

    fn mnemonic_activate(&self, group_cycling: bool) -> bool {
        unsafe { from_glib(ffi::gtk_widget_mnemonic_activate(self.upcast().to_glib_none().0, group_cycling.to_glib())) }
    }
    ...
    fn child_focus(&self, direction: ::DirectionType) -> bool {
        unsafe { from_glib(ffi::gtk_widget_child_focus(self.upcast().to_glib_none().0, direction)) }
    }
    ...
    fn get_size_request(&self) -> (i32, i32) {
        ...
        unsafe { ffi::gtk_widget_get_size_request(self.upcast().to_glib_none().0, &mut width, &mut height) };
        (width, height)
    }

    fn set_child_visible(&self, is_visible: bool) {
        unsafe { ffi::gtk_widget_set_child_visible(self.upcast().to_glib_none().0, is_visible.to_glib()) }
    }
    ...
    fn set_no_show_all(&self, no_show_all: bool) {
        unsafe { ffi::gtk_widget_set_no_show_all(self.upcast().to_glib_none().0, no_show_all.to_glib()) }
    }
    ...
    fn list_mnemonic_labels(&self) -> Vec<Widget> {
        unsafe {
            Vec::from_glib_container(ffi::gtk_widget_list_mnemonic_labels(self.upcast().to_glib_none().0))
        }
    }

    fn add_mnemonic_label<T: Upcast<Widget>>(&self, label: &T) {
        unsafe { ffi::gtk_widget_add_mnemonic_label(self.upcast().to_glib_none().0, label.upcast().to_glib_none().0) }
    }

    fn remove_mnemonic_label<T: Upcast<Widget>>(&self, label: &T) {
        unsafe { ffi::gtk_widget_remove_mnemonic_label(self.upcast().to_glib_none().0, label.upcast().to_glib_none().0) }
    }
    ...
    fn keynav_failed(&self, direction: ::DirectionType) -> bool {
        unsafe { from_glib(ffi::gtk_widget_keynav_failed(self.upcast().to_glib_none().0, direction)) }
    }
    ...
    fn set_has_tooltip(&self, has_tooltip: bool) {
        unsafe { ffi::gtk_widget_set_has_tooltip(self.upcast().to_glib_none().0, has_tooltip.to_glib()) }
    }
    ...
    fn set_can_default(&self, can_default: bool) {
        unsafe { ffi::gtk_widget_set_can_default(self.upcast().to_glib_none().0, can_default.to_glib()) }
    }
    ...
    fn set_can_focus(&self, can_focus: bool) {
        unsafe { ffi::gtk_widget_set_can_focus(self.upcast().to_glib_none().0, can_focus.to_glib()) }
    }
    ...
    fn set_has_window(&self, has_window: bool) {
        unsafe { ffi::gtk_widget_set_has_window(self.upcast().to_glib_none().0, has_window.to_glib()) }
    }
    ...
    fn set_state_flags(&self, flags: ::StateFlags, clear: bool) {
        unsafe { ffi::gtk_widget_set_state_flags(self.upcast().to_glib_none().0, flags, clear.to_glib()) }
    }
    ...
    fn set_receives_default(&self, receives_default: bool) {
        unsafe { ffi::gtk_widget_set_receives_default(self.upcast().to_glib_none().0, receives_default.to_glib()) }
    }
    ...
    fn set_support_multidevice(&self, support_multidevice: bool) {
        unsafe { ffi::gtk_widget_set_support_multidevice(self.upcast().to_glib_none().0, support_multidevice.to_glib()) }
    }

    fn get_support_multidevice(&self) -> bool {
        unsafe { from_glib(ffi::gtk_widget_get_support_multidevice(self.upcast().to_glib_none().0)) }
    }

    fn set_realized(&self, realized: bool) {
        unsafe { ffi::gtk_widget_set_realized(self.upcast().to_glib_none().0, realized.to_glib()) }
    }
    ...
    fn get_preferred_height(&self) -> (i32, i32) {
        ...
        unsafe { ffi::gtk_widget_get_preferred_height(self.upcast().to_glib_none().0, &mut minimum_height, &mut natural_height); }
    ...
    fn get_preferred_width(&self) -> (i32, i32) {
        ...
        unsafe { ffi::gtk_widget_get_preferred_width(self.upcast().to_glib_none().0, &mut minimum_width, &mut natural_width); }
    ...
    fn get_preferred_height_for_width(&self, width: i32) -> (i32, i32) {
        ...
        unsafe { ffi::gtk_widget_get_preferred_height_for_width(self.upcast().to_glib_none().0, width, &mut minimum_height, &mut natural_height) };
        (minimum_height, natural_height)
    }
    ...
    fn get_preferred_width_for_height(&self, height: i32) -> (i32, i32) {
        ...
        unsafe { ffi::gtk_widget_get_preferred_width_for_height(self.upcast().to_glib_none().0, height, &mut minimum_width, &mut natural_width) };
        (minimum_width, natural_width)
    }
    ...
    fn get_preferred_height_and_baseline_for_width(&self, width: i32) -> (i32, i32, i32, i32) {
        ...
        unsafe { ffi::gtk_widget_get_preferred_height_and_baseline_for_width(self.upcast().to_glib_none().0, width, &mut minimum_height,
    ...
    fn set_hexpand_set(&self, expand: bool) {
        unsafe { ffi::gtk_widget_set_hexpand_set(self.upcast().to_glib_none().0, expand.to_glib()) }
    }
    ...
    fn set_vexpand_set(&self, expand: bool) {
        unsafe { ffi::gtk_widget_set_vexpand_set(self.upcast().to_glib_none().0, expand.to_glib()) }
    }
    ...
    fn compute_expand(&self, orientation: ::Orientation) -> bool {
        unsafe { from_glib(ffi::gtk_widget_compute_expand(self.upcast().to_glib_none().0, orientation)) }
    }
    ...
    fn child_notify(&self, child_property: &str) {
        unsafe { ffi::gtk_widget_child_notify(self.upcast().to_glib_none().0, child_property.to_glib_none().0) }
    }
