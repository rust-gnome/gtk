...
pub trait DialogBuilder {
    ...
    fn dialog_with_buttons<T: DialogButtons>(&self, title: &str, parent: Option<::Window>,
        flags: ::DialogFlags, buttons: T) -> Dialog;
}

impl DialogBuilder for ::Gtk {
    fn dialog(&self) -> Dialog {
        unsafe {
            ::FFIWidget::wrap_widget(ffi::gtk_dialog_new())
        }
    }
    ...
    fn dialog_with_buttons<T: DialogButtons>(&self, title: &str, parent: Option<::Window>,
        ...
        unsafe {
            ...
            ::FFIWidget::wrap_widget(buttons.invoke3(ffi::gtk_dialog_new_with_buttons,
                title.borrow_to_glib().0, parent, flags))
        }
    }
}
